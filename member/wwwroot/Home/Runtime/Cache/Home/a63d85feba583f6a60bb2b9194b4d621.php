...
<div class="jumppage" style="display:none;">
	...
	<div class="tx1"></div>
	<!--<div class="btn2" id="Jq_sure"><?php echo (L("Sure")); ?></div>
    <div class="btn3" id="Jq_no"><?php echo (L("Cancel")); ?></div>-->
      ...
      <div class="tableContent">
        ...
        <div class="sideBar">
          <div class="catalogList">
            <ul>
				<li class="selected" > <a href="/index.php/User/"><?php echo (L("Member")); ?></a></li>
...
<div class="content">
          ...
          <div class="msgWrap">
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR>
                  <TH><?php echo (L("Member_Name")); ?></TH>
				  <TH width="10%"><?php echo (L("Identification_id")); ?></TH>
                  <TH width="30%"><?php echo (L("Operation")); ?></TH>
                </TR>
              </THEAD>
              <TBODY>
                <TR></TR>
                <?php if(is_array($myfamily)): $i = 0; $__LIST__ = $myfamily;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><TR>
                  <TD><p><?php echo ($vo["familyname"]); ?></p></TD>
				  <TD><p><?php echo ($vo["familyid"]); ?></p></TD>
                  <TD class="norightborder" id="data_<?php echo ($vo["pid"]); ?>" dataName="<?php echo ($vo["familyname"]); ?>">
				  <a href="/index.php/Home/User/edit/id/<?php echo ($vo["pid"]); ?>/" class="btnGreens" ><?php echo (L("Edit")); ?></a>
...
<script type="text/javascript">
	function Jq_del(id){
		...
		$('#Jq_sure').click(function(){
			var url = "/index.php/Home/User/del/id/"+id;
